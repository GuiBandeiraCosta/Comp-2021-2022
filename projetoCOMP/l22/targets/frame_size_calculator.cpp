...
void l22::frame_size_calculator::do_with_vector_update_node(l22::with_vector_update_node *const node, int lvl) {
  
}

void l22::frame_size_calculator::do_iterate_node(l22::iterate_node *const node, int lvl) {

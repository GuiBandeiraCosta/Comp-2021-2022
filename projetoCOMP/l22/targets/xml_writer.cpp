...
void l22::xml_writer::do_with_vector_update_node(l22::with_vector_update_node *const node, int lvl){
  openTag(node,lvl);
  openTag("function", lvl);
  node->function()->accept(this, lvl + 4);
  closeTag("function", lvl);
  openTag("low", lvl);
...
void l22::xml_writer::do_iterate_node(l22::iterate_node *const node, int lvl){
